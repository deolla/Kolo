...
class Transaction(Base, db.Model):
    ...
    transaction_type = db.Column(db.String(60), nullable=False) # deposit, withdraw, refund, refund or transfer.
    amount = db.Column(db.Integer, nullable=False)
    transaction_date = db.Column(db.DateTime, nullable=False)
    description = db.Column(db.String(60), nullable=True)
    status = db.Column(db.String(60), nullable=False) # Completed or pending transaction.
